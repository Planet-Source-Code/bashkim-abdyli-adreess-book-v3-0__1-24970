...
'=====================================================================
'Used to retrieve Windows RegisteredOwner
'=====================================================================
Public Function RegisteredOwner() As String
   RegisteredOwner = Trim$(GetStringValue("HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion", "RegisteredOwner"))
   If Len(RegisteredOwner) < 1 Then
...
'=====================================================================
'Used to retrieve Windows RegisteredOwner's Organization/Company Name
'=====================================================================
Public Function RegisteredOrganization() As String
   RegisteredOrganization = GetStringValue("HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion", "RegisteredOrganization")
End Function
'=====================================================================
